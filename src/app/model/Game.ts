...
//     street: Street;
    ...
    constructor(meta_game: MetaGame, width: number, height: number, intensity: number) {
        ...
        this.map = new GameMap(this, width, height, this.mapMaker.ground, this.mapMaker.start_road, this.mapMaker.end_road, (intensity < 2)? 0 : (intensity < 4)? 0.25 : (intensity < 6)? 0.5 : (intensity < 8)? 0.75 : 1);
